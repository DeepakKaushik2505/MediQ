          ...
          <div className="p-6 md:p-8">
            ...
            <div className="mb-10">
              ...
              <p className="text-gray-700 leading-relaxed">
                At MediQ, we're committed to making healthcare accessible to everyone. Our platform connects patients with qualified healthcare professionals, streamlining the appointment booking process and ensuring you receive timely care when you need it most.
              </p>
            </div>
            ...
            <div className="mb-10">
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                MediQ was founded by a team of healthcare professionals and technology experts who understand the challenges patients face when seeking medical care. Our diverse team works tirelessly to improve the healthcare experience.
              </p>
            ...
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-[#F8F2DE] p-4 rounded-lg italic">
                  <p className="text-gray-700 mb-3">"MediQ made it so easy to find a specialist and book an appointment. I was seen within two days of booking!"</p>
